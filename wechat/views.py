...
class CustomWeChatView(WeChatView):
    ...
    handlers = [
        HelpOrSubscribeHandler, UnbindOrUnsubscribeHandler, BindAccountHandler, BookEmptyHandler, CalculateHandler, BookWhatHandler,
        BookHeaderHandler, GetTicketHandler, CancelTicketHandler
    ]
